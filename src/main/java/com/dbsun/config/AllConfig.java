...
//		}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		addInterceptor.excludePathPatterns("/notice_system/**");
		addInterceptor.excludePathPatterns("/wc_**/**");
		addInterceptor.excludePathPatterns("/luc_**/**");
		addInterceptor.excludePathPatterns("/cnt_sign_and_meb**/**");
		addInterceptor.excludePathPatterns("/fs_**/**");
		addInterceptor.excludePathPatterns("/bac_conf/**");
		addInterceptor.excludePathPatterns("/pho_Record**/**");
		addInterceptor.excludePathPatterns("/del_/**");
...
//		/*客户*/
//		addInterceptor.excludePathPatterns("/cus_**/**");
//		addInterceptor.excludePathPatterns("/fin_**/**");
//		addInterceptor.excludePathPatterns("/bac_**/**");
//		addInterceptor.excludePathPatterns("/pho_**/**");
//		addInterceptor.excludePathPatterns("/tas_**/**");
//		addInterceptor.excludePathPatterns("/imp_**/**");
//		addInterceptor.excludePathPatterns("/cor_**/**");
//		addInterceptor.excludePathPatterns("/spr_**/**");
