...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #fluxswitch] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #fluxswitch] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #fluxswitch][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \"fluxswitch\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \"fluxswitch\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .fluxswitch][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \"fluxswitch\"]");
  ...
  MT("hamlAfterRubyTag",
    ...
    "  [tag strong][operator&special =] [variable now]",
    "  [attribute&qualifier .fluxswitch]",
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable fluxswitch]}[string _]#{[variable ting]}[string \"]} fluxswitch");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable fluxswitch]}[string _]#{[variable ting]()}[string \"]) Test");
})();
